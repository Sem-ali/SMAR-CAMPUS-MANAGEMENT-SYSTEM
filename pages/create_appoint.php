...
<head>
    ...
    <style>
        ...
        input[type="date"], input[type="time"] { width: 100%; max-width: 400px; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1; font-family: 'Inter', sans-serif; background: #f8fafc; box-sizing: border-box; margin-bottom: 15px; }
...
<body>
    <div class="container">
        ...
        <form action="process/create_appoint_process.php" method="POST">
            <label>Date:</label>
