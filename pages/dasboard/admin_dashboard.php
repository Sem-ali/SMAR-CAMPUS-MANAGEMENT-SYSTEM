...
// Fetch all requests
$result = $conn->query("SELECT r.request_id, r.title, r.status, r.created_date, u.name 
                        FROM request r
                        JOIN users u ON r.requester_person_id = u.id
...
<div class="navbar">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <a href="../search_request.php" target="_blank">Search Requests</a>
...
<div class="dashboard-container">
    <h2>Admin Dashboard &mdash; Welcome, <?php echo htmlspecialchars($_SESSION['name']); ?></h2>

<?php
// Counts
$total   = $conn->query("SELECT COUNT(*) AS c FROM request")->fetch_assoc()['c'];
$pending = $conn->query("SELECT COUNT(*) AS c FROM request WHERE status='Pending'")->fetch_assoc()['c'];
$done    = $conn->query("SELECT COUNT(*) AS c FROM request WHERE status='Completed'")->fetch_assoc()['c'];
?>

<div style="display:flex;gap:20px;margin:16px 0;">
    <div class="card"><strong>Total Requests:</strong> <?php echo $total; ?></div>
    <div class="card"><strong>Pending:</strong> <?php echo $pending; ?></div>
    <div class="card"><strong>Completed:</strong> <?php echo $done; ?></div>
</div>
    ...
    ?>
        <div class="request-card">
            ...
            <div class="request-card-body">
                Student: <strong><?php echo htmlspecialchars($row['name']); ?></strong><br>
